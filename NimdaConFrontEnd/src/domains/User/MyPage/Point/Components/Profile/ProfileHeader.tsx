      ...
      <div className="inline-flex pl-8 pr-[510px] items-start gap-6 overflow-visible">
        <div ref={avatarMenuRef} className="relative overflow-visible">
          ...
          >
            ...
            />
            <div className="absolute left-1/2 top-1/2 flex h-40 w-40 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            {uploading && (
              <div className="absolute left-1/2 top-1/2 flex h-40 w-40 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full">
