          ...
          <div className="sidebar-profile__stats">
            <div className="sidebar-profile__stat-item">
              <div className="sidebar-profile__stat-icon">
                ...
                >
                  ...
                  />
                  <path
                    d="M2.5 12.5C2.5 10.3 4.5 9 7 9s4.5 1.3 4.5 3.5"
                    stroke="#0C0C0C"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                  />
              ...
              <span className="sidebar-profile__stat-value">
                <strong>{visitCount}</strong> 회
              </span>
            </div>
            <div className="sidebar-profile__stat-item">
              <div className="sidebar-profile__stat-icon">
                ...
                >
                  <path
                    d="M11.5 2.5h-9a1 1 0 0 0-1 1v9a1 1 0 0 0 1 1h9a1 1 0 0 0 1-1v-9a1 1 0 0 0-1-1z"
                    stroke="#0C0C0C"
                    strokeWidth="1.5"
                  />
                  <path
                    d="M4.5 5.5h5M4.5 8h5M4.5 10.5h3"
                    stroke="#0C0C0C"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                  />
            ...
            <div className="sidebar-profile__stat-item">
              <div className="sidebar-profile__stat-icon">
                ...
                >
                  <path
                    d="M12.5 2.5h-11v8h4l3 2.5v-2.5h4v-8z"
                    stroke="#0C0C0C"
                    strokeWidth="1.5"
            ...
            <div className="sidebar-profile__stat-item">
              <div className="sidebar-profile__stat-icon">
                ...
                >
                  <path
                    d="M7 12.5l-1-.9C3.4 9 1.5 7.3 1.5 5.2a2.8 2.8 0 0 1 2.8-2.8c1.6 0 2.6 1 3.2 1.6.6-.6 1.6-1.6 3.2-1.6a2.8 2.8 0 0 1 2.8 2.8c0 2.1-1.9 3.8-4.5 6.4l-1 .9z"
                    stroke="#0C0C0C"
                    strokeWidth="1.5"
                    strokeLinejoin="round"
                  />
            ...
            <div className="sidebar-profile__stat-item">
              ...
              <span className="sidebar-profile__stat-value">
                <strong>{coinBalance}</strong> NC
              </span>
            </div>
          </div>
        ) : (
          <>
            <p className="sidebar-profile__desc">로그인 후 이용할 수 있습니다.</p>
  ...
  const renderCategoryItems = (items: any[]) => {
    return items.map((item) => {
      ...
      const isParentActive =
        location.pathname === `/board/${item.slug}` && !currentTab;

      return (
        <React.Fragment key={item.id}>
          <li
            className={`sidebar-section__item ${isParentActive ? 'sidebar-section__item--active' : ''}`}
          >
            {item.redirectUrl ? (
              <a
          ...
          {itemHasChildren &&
            item.children.map((child: any) => {
              ...
              return (
                <li
                  key={child.id}
                  className={`sidebar-section__item sidebar-section__item--depth ${isChildActive ? 'sidebar-section__item--active' : ''}`}
                ...
                >
                  {child.redirectUrl ? (
                    ...
                    <Link
                      to={`/board/${item.slug}?tab=${child.slug}`}
                      className="sidebar-section__link"
                    >
                      {child.name}
                    </Link>
      ...
      >
        {hasChildren ? (
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="sidebar-section__title sidebar-section__title--link"
          >
            {category.name}
          </a>
        ) : (
          <Link
            to={`/board/${category.slug}`}
            className="sidebar-section__title sidebar-section__title--link"
          >
            {category.name}
          </Link>
